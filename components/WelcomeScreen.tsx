    ...
    <>
      <div className="flex flex-col items-center p-8 bg-gray-900 min-h-screen">
          ...
          <div className="relative">
            {isImageLoading ? (
              ...
              <img 
                src={profileImageUrl} 
                alt="Profil Pengguna" 
                className="w-32 h-32 rounded-full object-cover border-4 border-gray-700 cursor-pointer hover:border-gray-600 transition-all duration-300 hover:scale-105"
                onClick={openAvatarModal}
              />
            ) : (
              <div 
                className="w-32 h-32 rounded-full bg-gray-800 border-4 border-gray-700 cursor-pointer hover:border-gray-600 transition-all duration-300 hover:scale-105 flex items-center justify-center"
                onClick={openAvatarModal}
              >
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              <input
                ...
                className="w-full px-4 py-4 bg-gray-800 border border-gray-700 rounded-2xl text-white placeholder-gray-400 focus:ring-2 focus:ring-sky-500 focus:border-transparent outline-none transition-all duration-300"
              />
        ...
        <div className="mt-8 w-full max-w-md space-y-3">
          <button
            ...
            className="w-full bg-gray-800 hover:bg-gray-700 border border-gray-700 hover:border-gray-600 text-white font-semibold py-3 px-6 rounded-2xl transition-all duration-300 hover:scale-105 flex items-center justify-center space-x-2"
          >
      ...
      {showAvatarModal && (
        <div className="fixed inset-0 bg-black/70 flex items-center justify-center p-4 z-50">
          <div className="bg-gray-800 border border-gray-700 rounded-3xl p-6 w-full max-w-lg max-h-[80vh] overflow-y-auto">
              ...
              {DEFAULT_AVATARS.map((avatar, index) => (
                ...
                >
                  <img
                    src={avatar}
                    alt={`Avatar ${index + 1}`}
                    className="w-16 h-16 rounded-full border-2 border-gray-700 hover:border-sky-500 transition-all duration-300 group-hover:scale-110"
                  />
